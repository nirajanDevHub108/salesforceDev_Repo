...
export default class AgentforceHomepage extends NavigationMixin(
  LightningElement
) {
  ...
  get launchBannerStyle() {
    return this.launchBannerUrl
      ? `background-image: url(${this.launchBannerUrl});`
      : "";
  }
  ...
  get practiceBannerStyle() {
    return this.practiceBannerUrl
      ? `background-image: url(${this.practiceBannerUrl});`
      : "";
  }
  ...
  get learnBannerStyle() {
    return this.learnBannerUrl
      ? `background-image: url(${this.learnBannerUrl});`
      : "";
  }
