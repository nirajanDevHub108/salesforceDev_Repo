...
describe("c-sample-list", () => {
  ...
  it("shuffles items when Shuffle clicked", () => {
    ...
    const button = element.shadowRoot.querySelector(
      'lightning-button[title="Shuffle"]'
    );
    button.click();
    ...
    return Promise.resolve()
      .then(() => {
        const items = Array.from(
          element.shadowRoot.querySelectorAll("li.list-item")
  ...
  it("resets items when Reset clicked", () => {
    ...
    const shuffleBtn = element.shadowRoot.querySelector(
      'lightning-button[title="Shuffle"]'
    );
    shuffleBtn.click();

    const reset = element.shadowRoot.querySelector(
      'lightning-button[title="Reset"]'
    );
    reset.click();
  ...
  it("shows empty message when no items", () => {
    ...
    return Promise.resolve().then(() => {
      ...
      const originalQuery = element.shadowRoot.querySelectorAll.bind(
        element.shadowRoot
      );
